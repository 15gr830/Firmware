...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/posEKF.a
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/posEKF.a
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/pos_codegen -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=posEKF -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/pos_codegen/posEKF.c
...
%.o : $(START_DIR)/pos_codegen/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/pos_codegen/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
